...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1, bezier = "md3_decel", delay = 3, style = "popin 60%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1, bezier = "md3_accel", delay = 3, style = "popin 60%" })
