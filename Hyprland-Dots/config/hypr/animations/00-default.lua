...
hl.animation({ leaf = "borderangle", enabled = true, speed = 1, bezier = "liner", loop = true })
hl.animation({ leaf = "fade", enabled = true, speed = 1, bezier = "smoothOut" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 1, bezier = "overshot" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 1, bezier = "winIn", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 1, bezier = "winOut", style = "slide" })
