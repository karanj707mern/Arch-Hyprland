...
${SKYBLUE}You can change later in ~/.config/hypr/CONF FILES/UserConfigs/UserSettings.conf${RESET}
...
"
  ...
  while true; do
    ...
    case $keyboard_layout in
      [yY])
        awk -v layout="$layout" '/kb_layout/ {$0 = "  kb_layout = " layout} 1' config/hypr/CONF FILES/configs/SystemSettings.conf >temp.conf
        mv temp.conf config/hypr/CONF FILES/configs/SystemSettings.conf
...
"
        ...
        echo -n "${CAT} - Please enter the correct keyboard layout: "
        read new_layout
        awk -v new_layout="$new_layout" '/kb_layout/ {$0 = "  kb_layout = " new_layout} 1' config/hypr/CONF FILES/configs/SystemSettings.conf >temp.conf
        mv temp.conf config/hypr/CONF FILES/configs/SystemSettings.conf
